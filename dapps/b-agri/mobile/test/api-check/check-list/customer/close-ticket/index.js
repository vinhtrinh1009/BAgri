...
module.exports = async function(iRequest, configs, headers, funcName) {
    ...
    const response = await iRequest(configs.APP_API + "/msx-lead/api/domain/v1/customer/service-request/closedByCustomer", "POST", headers, {}, null, {
        "id": "e027b4cf-7eeb-4f46-a835-947102c624b1"
    });
