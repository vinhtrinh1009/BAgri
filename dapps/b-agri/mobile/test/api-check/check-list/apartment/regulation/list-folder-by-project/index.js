...
module.exports = async function(iRequest, configs, headers, funcName) {
    ...
    const response = await iRequest(configs.APP_API + "/msx-property/api/query/v1/folder/findAllFolder?q=&page=1&pageSize=10&projectId=001fff8d-2876-aa1b-08f3-d98326351859", "GET", headers, {}, null, {});
