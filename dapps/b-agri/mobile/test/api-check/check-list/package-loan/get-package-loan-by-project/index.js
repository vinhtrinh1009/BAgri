...
module.exports = async function(iRequest, configs, headers, funcName) {
    ...
    const response = await iRequest(configs.APP_API + "/msx-property/api/query/v1/package-loan/by-project/ee5f740e-cd64-49ce-875b-b9842212da96?bank=Saocombank", "GET", headers, {}, null);
