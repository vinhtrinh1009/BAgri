    ...
    return (
        <>
            <div className="rowdata">
                <input type="text" value={attr.name} onChange={updateNameAttr} onBlur={onInputNameBlur} onFocus={onInputNameFocus} disabled={attr.is_old_data} />
                <select className="type_select" onChange={changeTypeOfAttr} defaultValue={attr.type} disabled={attr.is_old_data}>
                ...
                <span className="icon_function" style={{ width: "108px", justifyContent: "right" }}>
                    ...
                    <span className={attr.encrypt ? "encrypt" : ""} onClick={attr.is_old_data ? null : () => setEncrypt(!attr.encrypt)}>
                        <svg
