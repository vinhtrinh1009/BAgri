...
import ReactFlow, { removeElements, addEdge, MiniMap, Controls, Background, isNode, isEdge, ReactFlowProvider } from "react-flow-renderer";
...
import { findNodeById, swapSourceTarget, reverseString } from "./utils";
        ...
        <ReactFlowProvider>
            ...
            <div className={isConnecting ? "is_connecting reactflow-wrapper" : "reactflow-wrapper"}>
                <ReactFlow
                    minZoom={1}
                    maxZoom={1}
                    style={{ width: "100%", height: "calc(100vh - 290px)", zIndex: "0" }}
