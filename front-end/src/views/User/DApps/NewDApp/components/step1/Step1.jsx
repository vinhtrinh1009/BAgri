                ...
                <Row>
                    <Col xl={4} md={5} className="dapp_img_wrapper">
                        <div className="avata_wrapper">
                            ...
                            <div className="avata_upload img_uploaded" style={{ display: step1Data.dapp_logo ? "" : "none" }}>
                                <img src={step1Data.dapp_logo} style={{ width: "inherit", height: "inherit", objectFit: "cover" }} />
                            </div>
                    ...
                    <Col xl={8} md={7}>
                        ...
                        <FormControl fullWidth margin="normal" size="small" variant="filled">
                            ...
                            >
                                <ListSubheader>Ethereum Virtual Machine</ListSubheader>
                    ...
                    <Col xs={12}>
                        <div style={{ float: "right", marginTop: "43px" }}>
                            <Button
                                ...
                                disabled={
                                    step1Data.dapp_name && step1Data.dapp_description && step1Data.dapp_logo && step1Data.encryption_type && step1Data.network_id && checkDAppName() ? false : true
                                }
